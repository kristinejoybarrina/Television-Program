...
television1 = Television(30, 3, 1)
television2 = Television(3, 2, 1)
print(television1.turn_on(), television1.turn_off(), television1.get_channel(), television1.set_channel(), television1.get_volume(), television1.set_volume(), television1.channel_up(), television1.channel_down(), television1.volume_up(), television1.volume_down())

# Define a function in Test Television program
# Call all methods and print their function
# Create two objects
# Call instance method and print output
