...
print(television1.turn_on(), television1.turn_off(), television1.get_channel(), television1.set_channel(), television1.get_volume(), television1.set_volume(), television1.channel_up(), television1.channel_down() )
